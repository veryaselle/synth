...
def sdv_generate(method: str, model_df: pd.DataFrame, n: int, epochs: int, enable_gpu: bool, batch_size: int, verbose: bool):
    ...
    if method == "tvae":
        ...
        synth = CTGANSynthesizer(metadata, epochs=epochs, batch_size=batch_size, verbose=verbose, enable_gpu=enable_gpu)
    elif method == "copulagan":
        synth = CopulaGANSynthesizer(metadata, epochs=epochs, batch_size=batch_size, verbose=verbose, enable_gpu=enable_gpu)
