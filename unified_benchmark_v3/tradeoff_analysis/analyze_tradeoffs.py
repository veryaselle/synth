...
def main():
 ap=argparse.ArgumentParser(); ap.add_argument('--manifest',default=str(TRADEOFF_DIR/'gan_tradeoff_manifest.csv')); ap.add_argument('--frozen_root',default=str(BENCHMARK_ROOT/'results/main_benchmark')); ap.add_argument('--outdir',default=str(BENCHMARK_ROOT/'results/tradeoff_analysis')); a=ap.parse_args()
